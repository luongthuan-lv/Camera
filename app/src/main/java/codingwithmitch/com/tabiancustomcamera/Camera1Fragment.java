        ...
        VerticalSlideColorPicker.OnColorChangeListener
{
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        LocalBroadcastManager.getInstance(getContext()).registerReceiver(captureImage,
                new IntentFilter("capture_image"));
    }
...
//        mTrashContainer.setVisibility(View.INVISIBLE);
        ...
        mStillshotContainer.setVisibility(View.GONE);
        mPenContainer.setVisibility(View.GONE);
